export default function createPlayListElement(playlist) {
    const playListElement = document.createElement("div")

    playListElement.append(createPlayListHeader(playlist));
    playListElement.append(createTrackListElement(playlist.tracks));
